...
if (selected == 'About us'):
    ...
    st.write("At MatCare, our mission is to revolutionize healthcare by offering innovative solutions through predictive analysis. "
